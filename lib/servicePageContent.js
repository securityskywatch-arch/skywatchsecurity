...
function buildDefault(service) {
  ...
  return {
    ...
    introParagraphs: [
      `${service.description} Professional ${lc} helps protect employees, visitors, clients, and the assets your organisation relies on.`,
      `Without a structured approach to ${lc}, sites can be exposed to risks that are preventable with the right people, training, supervision, and reporting.`
    ],
...
const PATCHES = {
  ...
  "dog-handling": {
    heroKicker: "K9 Security & Dog Handling",
    heroTitle: "Professional K9 Security & Dog Handling Services",
    heroSubtitle: "Enhanced protection for high-risk sites across the UK.",
    primaryCtaLabel: "Request a K9 Quote",
    introParagraphs: [
      "K9 security pairs disciplined handlers with dogs selected and trained for the task\u2014whether you need a visible deterrent on a live construction site, overnight cover for warehousing and yards, or controlled search capability where your risk assessment and policy support it.",
      "SkyWatch plans deployments around your boundaries, public interfaces, induction rules, and reporting expectations so K9 support strengthens your SIA-aligned guarding model rather than sitting alongside it as an ungoverned add-on.",
      "We work within the Guard Dogs Act 1975 and apply British Standards BS 8517-1 and BS 8517-2 (security dogs\u2014code of practice) to how teams are briefed, supervised, and deployed, including welfare, signage, and lawful control of dogs on site."
    ],
    riskBullets: [
    ...
    advantages: [
      ...
      "Visual deterrent and rapid-response K9 units that reinforce your wider guarding and patrol package"
    ],
    whyChooseBullets: [
      "SIA-aligned guarding culture extended into K9 operations\u2014not ad-hoc \u201Cdog on site\u201D arrangements",
      ...
      "Ability to blend K9 cover with manned guarding, patrols, and monitoring on the same instruction set"
    ],
    offeringsTitle: "Related security services",
    faqs: [
      {
        question: "Are your K9 handlers and dogs certified?",
      ...
      {
        question: "Will K9 security replace manned guarding on my site?",
        answer: "Usually K9 complements SIA-licensed guarding: handlers hold appropriate licences for security roles, and dogs extend deterrence and detection. We recommend blended models unless your risk assessment clearly supports a K9-primary deployment."
      }
    ]
  }
};
