...
const PATCHES = {
  ...
  "dog-handling": {
    ...
    heroTitle: "Professional K9 Dog Handling Services",
    heroSubtitle: "Enhanced K9-led protection for high-risk sites across the UK.",
    primaryCtaLabel: "Request a Dog Handling Quote",
    introParagraphs: [
      "Professional K9 dog handling pairs disciplined handlers with dogs selected and trained for the task, whether you need a visible deterrent on a live construction site, overnight cover for warehousing and yards, or controlled search capability where your risk assessment and policy support it.",
