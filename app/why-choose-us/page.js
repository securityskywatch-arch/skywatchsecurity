...
function WhyChooseUsPage() {
  return /* @__PURE__ */ jsxs("main", { className: "min-w-0 flex-1 overflow-x-hidden bg-secondary dark:bg-base", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "page-container page-align space-y-12 py-12 lg:py-16", children: [
      /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold text-[#1a1a1a] dark:text-secondary", children: "Our values" }),
          /* @__PURE__ */ jsx("p", { className: "mt-3 leading-relaxed text-[#1a1a1a]/85 dark:text-sage", children: "We are committed to environments that feel safe and secure, underpinned by trust. Success is measured by client satisfaction and the consistency of our officers on the ground." }),
          /* @__PURE__ */ jsx("blockquote", { className: "mt-4 border-l-4 border-primary pl-4 italic text-[#1a1a1a]/90 dark:text-secondary/90", children: "\u201COur success is measured only by the satisfaction of our clients.\u201D" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(Reveal, { delay: 0.05, children: /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold text-[#1a1a1a] dark:text-secondary", children: "SIA-approved contractor disciplines" }),
          /* @__PURE__ */ jsx("p", { className: "mt-3 leading-relaxed text-[#1a1a1a]/85 dark:text-sage", children: "We align to the standards expected of professional UK security providers across door supervision, key holding, and security guarding. Policies, people, and procedures are maintained to support audit, assurance, and insurer confidence." }),
          /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm text-[#1a1a1a]/75 dark:text-sage", children: "Verify approved contractors on the official SIA ACS register when shortlisting suppliers." })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(Reveal, { delay: 0.1, children: /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold text-[#1a1a1a] dark:text-secondary", children: "Areas we cover" }),
          /* @__PURE__ */ jsxs("p", { className: "mt-3 leading-relaxed text-[#1a1a1a]/85 dark:text-sage", children: [
            "Deployment is focused across",
            " ",
            /* @__PURE__ */ jsx("strong", { className: "font-semibold text-[#1a1a1a] dark:text-secondary", children: "South East England" }),
            ",",
            " ",
            /* @__PURE__ */ jsx("strong", { className: "font-semibold text-[#1a1a1a] dark:text-secondary", children: "South West England" }),
            ", and",
            " ",
            /* @__PURE__ */ jsx("strong", { className: "font-semibold text-[#1a1a1a] dark:text-secondary", children: "Central England" }),
      ...
      /* @__PURE__ */ jsx(Reveal, { delay: 0.12, children: /* @__PURE__ */ jsx(
        ...
        {
          href: "/quote",
          className: "inline-flex rounded-md bg-primary px-6 py-3 text-sm font-semibold text-[#141414] transition hover:bg-accent",
