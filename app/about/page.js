...
const aboutFaqs = [
  ...
  },
  {
    ...
    a: "Yes. Officers are deployed in SIA-licensed roles with inductions aligned to your site hazards, customer profile, and access technology. Screening and vetting can be aligned to BS 7858 and your procurement rules."
  },
  {
...
function AboutPage() {
  return /* @__PURE__ */ jsxs("main", { className: "flex-1 bg-secondary dark:bg-base", children: [
    /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden border-b border-sage/30 bg-base py-16 text-secondary lg:py-20", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative page-container page-align", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "page-container py-16 page-align lg:py-20", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-12 text-left lg:grid-cols-2 lg:items-start", children: [
      /* @__PURE__ */ jsxs(Reveal, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-8 flex w-full max-w-md flex-col items-stretch gap-3 sm:max-w-none sm:flex-row sm:flex-wrap md:justify-start", children: [
          /* @__PURE__ */ jsxs(
            ...
            {
              href: "/standards",
              className: "inline-flex w-full items-center justify-center gap-2 rounded-md bg-primary px-5 py-2.5 text-sm font-semibold text-base transition hover:bg-accent md:w-auto",
              children: [
                "Our standards",
          ...
          /* @__PURE__ */ jsx(
            ...
            {
              href: "/why-choose-us",
              className: "inline-flex w-full items-center justify-center gap-2 rounded-md border border-sage/45 px-5 py-2.5 text-sm font-semibold text-primary transition hover:border-primary md:w-auto",
    ...
    /* @__PURE__ */ jsx(StaggerSection, { className: "border-y border-sage/20 bg-base/[0.04] py-16 dark:border-sage/25 dark:bg-secondary/[0.06]", children: /* @__PURE__ */ jsxs("div", { className: "page-container page-align", children: [
      /* @__PURE__ */ jsxs(StaggerItem, { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mx-auto mt-2 max-w-3xl text-sm text-base/75 dark:text-sage md:mx-0", children: "Each service has its own page with scope, typical deliverables, risks, and FAQs, similar to how leading UK providers structure their catalogue." })
      ] }),
      /* @__PURE__ */ jsx("ul", { className: "mt-10 grid grid-cols-1 gap-3 text-left md:grid-cols-3", children: serviceNavItems.map((item) => /* @__PURE__ */ jsx(StaggerItem, { children: /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(
        Link,
        {
          href: item.href,
    ...
    /* @__PURE__ */ jsx("section", { className: "page-container py-16 page-align", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-10 text-left lg:grid-cols-2 lg:items-center", children: [
      /* @__PURE__ */ jsxs(Reveal, { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "page-container py-16 page-align", children: [
      /* @__PURE__ */ jsxs(Reveal, { children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "page-container py-16 page-align lg:py-20", children: /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", { className: "brand-card-cta brand-card-interactive px-8 py-10 sm:px-12", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-8 flex w-full max-w-md flex-col items-stretch gap-3 sm:max-w-none sm:flex-row sm:flex-wrap sm:justify-center md:justify-start", children: [
        ...
        /* @__PURE__ */ jsxs(
          ...
          {
            href: "/about/policies",
            className: "inline-flex w-full items-center justify-center gap-2 rounded-md border-2 border-primary/60 bg-base px-6 py-3 text-sm font-bold text-secondary transition hover:bg-primary hover:text-base dark:bg-base dark:text-secondary md:w-auto",
            children: [
              "Browse all policies",
              /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })
            ]
